...
public class LoginController implements DemoConstant {
    ...
    public String register(Model model, User user) {
        ...
        if (map == null || map.isEmpty()) {
            model.addAttribute("msg", "注册成功，我们已向您的邮箱发送了一封激活邮件，请点击邮件中的链接激活账户。");
    ...
    // http://localhost:12345/activation/userId/activationCode
...
//        String kaptcha = (String) session.getAttribute("kaptcha");
    ...
    public String getForgetCode(String email, HttpSession session) {
        ...
        String code = DemoUtil.generateUUID().substring(0, 4);
